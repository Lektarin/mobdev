package com.mirea.marshevla.thread;
...
import com.mirea.marshevla.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("Мой номер группы: БИСО-01-20, № по списку: 19, мой любимый фильм: Форсаж");
