package com.mirea.marshevla.sensorlist;
...
import com.mirea.marshevla.sensorlist.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listSensor = binding.listView; // Убедитесь, что в XML есть android:id="@+id/list_view"
